...
let miServer = net.createServer((socket)=>{//'connection' listener
  socket.write('Welcome, servidor a puerto ' +port+ '\n');
...
rl.on('line', async (line) => {
  try{
    ...
    else if ('e'===cmd)  { rl.log('Bye!');socket.destroy();/*process.exit(0);*/}
